...
public static partial class BankToBankService
{
  ...
  {
    get { return global::BankToBankReflection.Descriptor.Services[0]; }
  }

  /// <summary>Base class for server-side implementations of BankToBankService</summary>
  [grpc::BindServiceMethod(typeof(BankToBankService), "BindService")]
  public abstract partial class BankToBankServiceBase
  {
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
